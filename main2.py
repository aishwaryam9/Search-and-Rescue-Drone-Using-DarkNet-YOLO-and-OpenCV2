...
# Loading video file/camera
cap = cv2.VideoCapture('drone.mp4') #insert 0 if using PC camera
...
while True:
    ...
    # Detecting objects
    blob = cv2.dnn.blobFromImage(frame, 0.00392, (416, 416), (0, 0, 0), True, crop=False) #extract 416x416 images
    net.setInput(blob)
